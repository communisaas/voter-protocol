...
/**
 * Validation result interface (deterministic validators return this)
 */
export interface ValidationResult {
  ...
  /** Non-critical warnings (do not cause rejection) */
...
export interface CityTarget {
  ...
  readonly fips?: string;   // US-specific FIPS code
}
...
export class DeterministicValidationPipeline {
  ...
  async validateWithGeography(
    ...
    const geoResult = await geoValidator.validate(geojson, {
      ...cityTarget,
