 ...
 *
 * PLANNED EXPANSION:
 * - Phase 1 (Complete Q1 2025): + NZ (New Zealand)
...
>([
  // Phase 1: Anglosphere (Implemented)
  ['GB', new UKBoundaryProvider()],
  ['CA', new CanadaBoundaryProvider()],
  ['AU', new AustraliaBoundaryProvider()],

  // Phase 1: Anglosphere (Pending)
  // ['NZ', new NewZealandBoundaryProvider()], // TODO: Implement NZ provider
