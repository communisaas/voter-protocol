...
**Total TypeScript Files:** 330+

---

## Overview

This document describes the architecture of Shadow Atlas as implemented. The system has evolved from the original 6-module design into a comprehensive 8-tier architecture with 41+ modules.

**Architecture Highlights:**
- **Global scaling**: 190+ countries via international provider architecture
- **Production-grade**: Security, observability, and resilience modules
- **Automated CI/CD**: Ops, deployment, and runbook infrastructure
- **Service-oriented**: Core service facade coordinating all operations
...
- `ShadowAtlasAPI` - Enhanced API with caching (v2)
...
- `api.ts` - v2 API with performance optimizations
...
**Critical Files:**
- `crawl-state-portals.ts` - State GIS portal crawler
...
| **API: Resolve Address** | `POST /resolve` | `serving/api.ts` |
