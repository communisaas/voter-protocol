/**
 * FIPS <-> State Code Mapping — single source of truth.
 *
 * Used by both the ingestion script and the officials service.
 */
...
export const TERRITORIES = new Set(['DC', 'AS', 'GU', 'MP', 'PR', 'VI']);
