...
export class RDHScanner {
  ...
  private stateToFips(state: string): string | null {
    // R58-C2: Complete FIPS mapping — all 50 states + DC + territories.
    // Previous version only covered 10 states, silently dropping 40.
    const fipsMap: Record<string, string> = {
      ...
      Nevada: '32', Ohio: '39', Oklahoma: '40', Oregon: '41', Pennsylvania: '42',
      Tennessee: '47', Texas: '48', Utah: '49', Vermont: '50', Virginia: '51',
      Washington: '53', Wisconsin: '55', Wyoming: '56',
      'New Hampshire': '33', 'New Jersey': '34', 'New Mexico': '35',
      'New York': '36', 'North Carolina': '37', 'North Dakota': '38',
      'Rhode Island': '44', 'South Carolina': '45', 'South Dakota': '46',
      'West Virginia': '54', 'District of Columbia': '11',
      'Puerto Rico': '72', 'American Samoa': '60', Guam: '66',
