...
export function calculateIntersectionArea(
  ...
  try {
    ...
    logger.warn('Failed to calculate intersection area', {
...
export function calculateUnionArea(
  ...
  try {
    ...
    logger.warn('Failed to calculate union area', {
      error: (error as Error).message,
    });
    return 0;
  }
...
export function calculateJaccardSimilarity(
  ...
  try {
    ...
    logger.warn('Failed to calculate Jaccard similarity', {
      error: (error as Error).message,
    });
    return 0;
  }
...
export function geometriesMatch(
  ...
  try {
    ...
    logger.warn('Failed to match geometries', {
      error: (error as Error).message,
    });
    return {
      matches: false,
...
export function calculateCentroid(
  ...
  try {
    ...
    logger.warn('Failed to calculate centroid', {
      error: (error as Error).message,
    });
    return [0, 0];
  }
...
export function calculateCentroidDistance(
  ...
  try {
    ...
    logger.warn('Failed to calculate centroid distance', {
      error: (error as Error).message,
    });
...
export function calculateArea(
  ...
  try {
    ...
    logger.warn('Failed to calculate area', {
      error: (error as Error).message,
    });
    return 0;
  }
