...
| `HonkVerifier_{18,20,22,24}.sol` | Depth-specific UltraHonk verifiers (generated by bb.js `getSolidityVerifier()`, registered in `VerifierRegistry`, dispatched by `DistrictGate.verifyTwoTreeProof()`) |
