> **ARCHIVED (historical only)** — This document is preserved for the two-tree registration/recovery flow details and the evolution narrative from single-tree → two-tree → three-tree.
>
> **Canonical cryptographic specification:** [`../CRYPTOGRAPHY-SPEC.md`](../CRYPTOGRAPHY-SPEC.md)
> **Engagement semantics (three-tree):** [`../REPUTATION-ARCHITECTURE-SPEC.md`](../REPUTATION-ARCHITECTURE-SPEC.md)
>
> **Resolved since this spec was frozen:** The NUL-001 wiring gap noted below ("shadow-atlas-handler.ts:136 uses request.leaf placeholder") was fixed — the Commons server now returns the canonical identity commitment via `tree1Data.identityCommitment` (see `commons/src/lib/core/identity/shadow-atlas-handler.ts:287`).

# Two-Tree Architecture Specification (Historical)

> **Spec ID:** TWO-TREE-ARCH-001
> **Version:** 0.7.0 (archived 2026-04-21)
> **Status:** SUPERSEDED by [`../CRYPTOGRAPHY-SPEC.md`](../CRYPTOGRAPHY-SPEC.md) + [`../REPUTATION-ARCHITECTURE-SPEC.md`](../REPUTATION-ARCHITECTURE-SPEC.md)
> **Date (original):** 2026-02-21
