> [!NOTE]
> **ARCHIVED (historical only) — Single-Tree Architecture**
>
> The original single-tree Noir circuit with 5 public outputs (`merkle_root, nullifier, authority_hash, epoch_id, campaign_id`).
>
> **Canonical cryptographic specification:** [`../CRYPTOGRAPHY-SPEC.md`](../CRYPTOGRAPHY-SPEC.md)
>
> This circuit is dead code on the current protocol. Kept for architectural context and understanding the single-tree → two-tree → three-tree evolution. See `../CRYPTOGRAPHY-SPEC.md` §11.1 for retirement details.
