...
**Architectural Relationship:** This document specifies boundary data sourcing — how we acquire and normalize governance boundary data from public sources worldwide. For cryptographic tree architecture (circuits, Merkle trees, nullifier scheme, trusted setup), see [`specs/CRYPTOGRAPHY-SPEC.md`](CRYPTOGRAPHY-SPEC.md) (canonical).
 ...
 * See specs/CRYPTOGRAPHY-SPEC.md for epoch-based tree management.
 *
...
### Resolved Questions (See specs/CRYPTOGRAPHY-SPEC.md)
