...
> Engagement tree semantics: [`specs/REPUTATION-ARCHITECTURE-SPEC.md`](../../specs/REPUTATION-ARCHITECTURE-SPEC.md).
> Proof system: UltraHonk/Noir via `@aztec/bb.js` (not UltraPlonk/Halo2 as described below).
